...
echo "docker run -d --network Cosm-net -v /home/civico129/MyProject/COSM-fastApi/host:/app/host -e FASTAPI_HOST=${FASTAPI_HOST} -e FASTAPI_PORT=${FASTAPI_PORT} -p ${FASTAPI_PORT}:${FASTAPI_PORT} --name CosmFastApi cosm-fastapi"
      docker run -d --network Cosm-net -v /home/civico129/MyProject/COSM-fastApi/host:/app/host -e FASTAPI_HOST=${FASTAPI_HOST} -e FASTAPI_PORT=${FASTAPI_PORT} -p ${FASTAPI_PORT}:${FASTAPI_PORT} --name CosmFastApi cosm-fastapi
